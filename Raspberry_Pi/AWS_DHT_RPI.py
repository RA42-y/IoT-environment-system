...
#device id
cmdUtils.register_command("device_id", "<int>", "The device id to send to the iot core.", default=3, type=int)
#gpio pin
cmdUtils.register_command("gpio", "<int>", "The gpio to declare to connect the sensor.", default=4, type=int)
...
if __name__ == '__main__':
    ...
    if message_string:
        ...
        while (publish_count <= message_count) or (message_count == 0):
            ...
            humidity_p = humidity
            device_id = cmdUtils.get_command("device_id")
            # message = ("Temperature = {:.1f}C Humidity = {:.1f}%".format(temperature_c, humidity))
            # print("Publishing message to topic '{}': {}".format(message_topic, message))
            message_json = '{ "device_id": ' + "{:d}".format(device_id) + ',"temperature": ' + "{:.1f}".format(temperature_c) + ',"humidity": ' + "{:.1f}".format(humidity_p) + ' }'
